...
def sysCall_init():
    ...
    sensor_left, sound, sound_2, sensor_right = hcsr04.read()
...
def turnToHeading():
    ...
    #todo: implement nikita's current heading func
    currentHeading =
...
def sysCall_actuation():
    ...
    #todo: write implementation of velocity to motors
...
def sysCall_sensing():
    ...
    res_fr, dist_fr, pt_fr, x, y = sound
    res_fr2, dist_fr2, pt_fr2, x, y = sound2
    # res_l, dist_l, pt_l, x, y = sensor_left
    # res_r, dist_r, pt_r, x, y = sensor_right
